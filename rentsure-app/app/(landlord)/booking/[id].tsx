...
function AgreementSection({ bookingId }: { bookingId: string }) {
  ...
  return (
    <View style={styles.section}>
      ...
      <View style={styles.infoCard}>
        <TouchableOpacity style={styles.pdfRow} onPress={() => router.push(`/agreement/${agreement.id}`)}>
...
const styles = StyleSheet.create({
  ...
  hero: { backgroundColor: colors.surface, borderRadius: borderRadius.lg, padding: spacing.md, marginBottom: spacing.md, ...shadows.sm },
  ...
  infoCard: { backgroundColor: colors.surface, borderRadius: borderRadius.lg, overflow: 'hidden', ...shadows.sm },
  ...
  tenantCard: { backgroundColor: colors.surface, borderRadius: borderRadius.lg, paddingVertical: spacing.sm, ...shadows.sm },
